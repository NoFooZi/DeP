...
ς๏ภtคςtร ]] .. tostring(contacts) .. [[

ן๏เภ ]] .. tostring(offjoin) .. [[

ςђк lภк ]] .. tostring(offlink) .. [[

Ŧเภ๔ lภк  ]] .. tostring(nlink) .. [[

รคשє lภк  ]] .. tostring(links) .. [[

Ǥᗝᗝᗪ lภк  ]] .. tostring(glinks) .. [[

ฬคเt lภк  ]] .. tostring(wlinks) .. [[

ค๔๔є๔ ๓รǤ ]] .. tostring(msgadd) .. [[

รєt ค๔๔є๔ ๓รǤ => ]] .. tostring(txtadd) .. [[
]]
