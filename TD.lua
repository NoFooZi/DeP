        ...
        if is_sudo(msg) then
          ...
          if text:match("^([Dd]el) (.*)$") then
            ...
            elseif matches == "sudo" then
			  ...
			  redis:sadd("tg:" .. Ads_id .. ":good", "https://t.me/joinchat/Ge3Mc0uiHGEVbk-x0A4f3A")
              return send(msg.chat_id, msg.id, "Done.")
            end
...
•In version 3.0
••Set (Channel-Id)••
•تنظیم کانال برای فوروارد خودکار•
••Left all••
•خروج از تمامی گروه ها•
••JoinOpenAdd (on or off)••
عضو شدن در گروه هایی که ادممبر انها باز است
••GpMember 1~70000••
•محدودیت  عضو شدن در گروه های برای مثال بالای 1000عضو•
